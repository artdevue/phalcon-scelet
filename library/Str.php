...
/**
 * Created by Artdevue.
 * User: artdevue - Str.php
 * Date: 06/11/2018
 * Time: 13:12
 * Project: phalcon-vue-spa.com
 *
 * Class Str  * @package Library
 */
...
class Str extends Component
{
     ...
     * @return string
     */
    public static function plural($count, $forms, $locale = 'en')
    {
        if (!is_array($forms))
        {
            $forms = explode(';', $forms);
